...
class BinaryProcess(Process):
    ...
    def data_preprocess(self):
        ...
        train_dataset_params = {"img_df": train_img_df, "transform": train_transform, "binary": True}
        ...
        valid_dataset_params = {"img_df": valid_img_df, "transform": valid_transform, "binary": True}
    ...
    def __auc_scoring(self, y_true, y_pred):
        score = roc_auc_score(y_true.reshape(-1),
                              y_pred.reshape(-1))
        return score
